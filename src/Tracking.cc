                                                                                                                                                                                              ...
                                                                                                                                                                                              mpFrameDrawer(pFrameDrawer), mpMapDrawer(pMapDrawer), mpMap(pMap), mnLastRelocFrameId(0)
{
    ...
    cv::Mat DistCoef(4, 1, CV_32F); // distortion paramters
...
void Tracking::CreateInitialMapMonocular()
{
    ...
    mLastFrame = Frame(mCurrentFrame); // set last frame as current
...
bool Tracking::NeedNewKeyFrame()
{
    ...
    // Only for stereo camrea or RGB-D camera?
    ...
    // 4 conditions mention in the paper:
    // ORB-SLAM1 Sec.V(Tracking).E. New Keyframe Decision
