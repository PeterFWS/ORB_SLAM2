...
void ImageGrabber::GrabImage(const sensor_msgs::ImageConstPtr &msg)
{
	...
	// ---------------------------------------------------------
	// modification for Rosario
	// ---------------------------------------------------------
	float f_mask_position_y = mpSLAM->mpTracker->mCurrentFrame.mf_min_y_pixel_coor; // in Frame.cc, this variable is used for rejecting sky points, now it is used for masking
