...
where the images are geo-referenced by GPS directly, this means the poses are not estimated from SLAM anymore.
...
int main(int argc, char **argv)
{
    ...
    {
        cerr << endl
             << "Usage: rosrun ORB_SLAM2 Remode_feeder path_to_image_folder path_to_pose_txt_file loop_rate" << endl;
        ros::shutdown();
        return 1;
    }
