...
The modification is saved in different sub-branch:

- Branch fw/agriculture is modified for a agriculture robotic dataset Rosario. Where the sky is masked out real-time during tracking.
- Branch fw/planarSLAM is an ongoing research project that integrates PlaneRCNN/ PlaneNet as a detector of walls and floors for reconstructing building interiors.
...
[Stereo and RGB-D] Raúl Mur-Artal and Juan D. Tardós. **ORB-SLAM2: an Open-Source SLAM System for Monocular, Stereo and RGB-D Cameras**. _ArXiv preprint arXiv:1610.06475_ **[PDF](https://128.84.21.199/pdf/1610.06475.pdf)**.
...
2. Go to _Examples/ROS/ORB_SLAM2_ folder and execute:
